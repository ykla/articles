...
本文件试图代表社区共识，因此它不能被视为完全*权威*的文件。然而，如果你发现本文件中的技术错误，或者有关于应该添加的条目的建议，请提交一个 PR，或者通过电子邮件联系 [FreeBSD 文档项目邮件列表](https://lists.freebsd.org/subscription/freebsd-doc)。谢谢。
