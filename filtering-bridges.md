...
也就是说，丢弃来自外部、声称来自我们网络的数据包。这是一种常见做法，以防止有人通过生成看似来自内部的恶意数据包来绕过数据包过滤器。这样做的问题在于，外部接口上至少有一台主机你不希望忽略：路由器。但通常情况下，ISP 在他们的路由器上已经做了反欺骗处理，所以我们不需要过多担心。
